...
export const fetchFileBreadcrumbs = createAsyncThunk(
...
export const downloadFile = createAsyncThunk('downloadFile', async (fileId) => {
  ...
  if (statusCode(response).ok) {
    ...
    response.blob().then((blob) => {
      ...
      link.href = url;
      link.download = decodedFileName || 'file';
      link.click();
    });
...
export const showCreateFolderModal = createAsyncThunk(
